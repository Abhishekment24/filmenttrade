...
const Header = () => {
  ...
  return (
    <div>
      <>
        <div
          className={`navbartop fixed top-0 bg-1 z-[400] header_bg py-[12px] lg:px-[24px] px-4 w-full justify-between flex items-center text-white mx-auto  ${
            isScrolled ? "bg-1" : ""
          }`}
        >
                ...
                <div className="py-7">
                  ...
                  {isConnected && chainId != InjectedChainId ? (
                    <>
                      ...
                      <div
                        onClick={disconnectMetamask}
                        className="text-[#939191] text-center nav_font text-xs font-medium"
                      >
                        Disconnect Wallet
                      </div>
                    </>
