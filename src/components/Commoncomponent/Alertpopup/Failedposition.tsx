...
interface PostionpopupProps {
  ...
  onClose: () => void;
  failpositionStatus: "created" | "closed";
}

const Failedpostion: React.FC<PostionpopupProps> = ({
  isOpen,
  onClose,
  failpositionStatus,
}) => {
              ...
              <div className="w-full">
                <div className="flex items-start  gap-3 w-full">
                  ...
                  <div className="  w-full">
                    ...
                    <div className="flex items-center justify-between w-full gap-1 ">
                      <p className="text-[#9CA3AF]  text-xs font-medium pool_font tracking-[0.06px]">
                        {failpositionStatus === "created" ? "Entry Price" : ""}
                      </p>

                      <p className="text-[#FFFFFF]  text-xs font-medium pool_font tracking-[0.06px]">
                        {failpositionStatus === "created" ? "$1,793.16 " : ""}
                      </p>
                    </div>
                  </div>
                </div>
