      ...
      <div className="max-[1023px]:container lg:max-w-full lg:w-full mx-auto">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-[16px]">
            <div className="flex items-center gap-[4px] pr-2 justify-center hover:bg-[#25272A] rounded-[4px] active:bg-[#25272A]">
              <span>
          ...
          <div className="flex items-center gap-[16px]">
            <p className="text-[#9CA3AF] pool_font text-[10px] font-medium tracking-[0.05px] px-1 hover:bg-[#25272A] rounded-[4px] active:bg-[#25272A]">
              Help
            </p>
            <p className="text-[#9CA3AF] pool_font text-[10px] font-medium tracking-[0.05px] px-1 hover:bg-[#25272A] rounded-[4px] active:bg-[#25272A]">
              Docs
