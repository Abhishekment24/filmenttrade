      ...
      <div className="max-[1023px]:container lg:max-w-full lg:w-full mx-auto">
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-[16px]">
            <p className="text-[#9CA3AF] cursor-pointer  pool_font text-[10px] font-medium tracking-[0.05px] py-[2px] px-2 hover:bg-[#25272A] rounded-[4px] active:bg-[#25272A]">
              Help
            </p>
            <p className="text-[#9CA3AF] cursor-pointer  pool_font text-[10px] font-medium tracking-[0.05px] px-2 py-[2px] hover:bg-[#25272A] rounded-[4px] active:bg-[#25272A]">
              Docs
            </p>
            <p className="text-[#9CA3AF] cursor-pointer  pool_font text-[10px] font-medium tracking-[0.05px] px-2 py-[2px] hover:bg-[#25272A] rounded-[4px] active:bg-[#25272A]">
              Share Feedback
