...
import { SingleSkeleton, SkeletonDefaultProps } from "@/components/Commoncomponent/SkeletonLoader";
...
const Middlesidecomponent: React.FC<MiddlesProps> = ({ onPriceClick, isPageLoading }) => {
  ...
  return (
    <>
      <div className="border-[1px] bg-[#1B1C1E] border-solid border-[#FFFFFF0D] max-[1023px]:my-5 h-[632px] overflow-y-scroll no-scrollbar">
        ...
        {isPageLoading ? <ShowOrderSkeleton /> : selectedTab == "orderbook" ? (
          <>
        ...
        return (
          <div key={index} className="border-t border-[#26282B] py-2">
            ...
            <SkeletonTheme {...SkeletonDefaultProps({ inline: true })} >
              ...
              <Skeleton width={33 - +firstWidth + "%"} containerClassName="opacity-0" />
              <Skeleton width={secondWidth + "%"} />
              <Skeleton width={33 - +secondWidth + "%"} containerClassName="opacity-0" />
