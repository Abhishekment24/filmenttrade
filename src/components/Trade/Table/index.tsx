      ...
      <div className=" bg-[#1B1C1E] pool_box_shadow border-[1px] border-solid border-[#25272A]    w-full ">
            ...
            {tabs.map((tab, index) => {
              return (
                <button
                  ...
                  className={`py-3  pool_font font-medium text-sm  ${tab.key == selectedTab
        ...
        {selectedTab == "positions" && (
          <div className=" w-full relative flex">
            <div className="flex flex-col relative w-[97%]  overflow-x-scroll border-t-[1px] border-solid border-[#25272A]">
              {/* <div className="w-full "> */}

              <div className="wallet_connected_font h-[3.5rem] flex text-[10px] border-b-[1px] border-solid border-[#25272A] font-normal text-[#939191]">
                <div className="text-left py-3 px-3 min-w-[8rem]">Token</div>
                <div className="text-left  py-3 px-3 min-w-[8rem]">Type</div>
                <div className=" text-center py-3 px-3 min-w-[8rem] ">
                  Position Size
                </div>
                <div className="text-center py-3 px-3 min-w-[8rem] ">
                  Collateral
                ...
                <div className="text-center py-3 px-3 min-w-[8rem]">PnL</div>
                <div className="text-center py-3 px-3 min-w-[8rem]">
                  Liquidation Price
                </div>
                <div className="text-center py-3 pl-3 pr-[60px] min-w-[8rem]">
                  Fees
                </div>
              ...
              {[1, 2, 3].map((item, key) => {
                return <div key={key} className="relative w-full">
                  <div className="nav_font w-full h-[3.5rem] text-xs flex font-light text-[#fff] border-b-[1px] border-solid border-[#25272A] ">
                    <div className="text-center py-3 px-3 flex flex-col min-w-[8rem]">
                    ...
                    <div className="text-center py-3 px-3 min-w-[8rem] ">25x</div>
                    <div className="text-center py-3 px-3 min-w-[8rem] ">
                      12.1252 USDC
                    </div>
                    <div className="text-center py-3 px-3 min-w-[8rem] ">
                    ...
                    <div className="text-center flex flex-col text-[#00CC99] py-3 px-3 min-w-[8rem]">
            ...
            <div className="w-[3%] mt-[3.5rem]">
              {[1, 2, 3].map((item, key) => {
                return <div key={key} className="rounded-[4px] h-[3.5rem]  border-solid border-[#313131] bg-[#1B1C1E] flex   items-center justify-center   ">
